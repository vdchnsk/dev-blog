    ...
    return(
        <div className="home__content__secondary">
            <div className="home__content__desk">
                <span style={{color:"#525252", margin:"0", textAlign:"center", display:"block", marginLeft:"auto ", marginRight:"auto", fontWeight:"600", paddingBottom:"10px"}}>Лучшие статьи за {month[1]} ✨</span>
