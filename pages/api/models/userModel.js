...
module.exports = models.Users || model("Users", schema) //Если модель уже создана, то импопртируем готовую , иначе - создаем новую модель.Не до конца понимаю , как именно это работает, но потратил я на это решении часа 4 своей жизни...