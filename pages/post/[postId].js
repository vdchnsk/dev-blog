				...
				<div className="post">
					<div className="post__content">
						<div className="post__content__heading">
							<h3 style={{ width: '50%' }}>
								{post.author} <span style={{ opacity: '50%', fontSize: '.9rem', fontWeight: '400' }}>{post.date}</span>
							</h3>
					...
					<div className="postComments__content">
						...
						<div className="postComments__content__body">
								...
								{post.comments.map((comment) => (
									<div style={{ padding: '1%' }} key={comment.id} className="body__comments__comment">
										<div
											...
											className="body__comments__comment__heading"
										>
											<span>{comment.author}</span>{' '}
											<span style={{ margin: '0 10px', fontWeight: '400', fontSize: '.8rem' }}>{comment.date}</span>
										</div>
										...
										<div className="body__comments__comment__footer">
											<button
												...
												className="body__comments__comment__footer__replyBut"
												style={{
													marginTop: '1%',
													fontSize: '.9rem',
													color: 'black',
							...
							<div className="body__comments__comment__actions">
								...
								/>
								<Button
									style={{ background: '#e2e2e2', margin: '0 10px', maxHeight: '30px', width: '190px' }}
									color={'secondary'}
								>
									Send
								</Button>
